...
// ----------------------------------------------------------------------------------------    
    ...
    int create_listener(
        ...
        if (bind(sock, reinterpret_cast<sockaddr *>(&sa), sizeof(sockaddr_in)) == -1) {   // if there was an error
            close_socket(sock);
...
// ----------------------------------------------------------------------------------------
    ...
    create_connection(
        ...
        if (bind(sock, reinterpret_cast<sockaddr *>(&local_sa), sizeof(sockaddr_in)) == -1) {   // if there was an error
            close_socket(sock);
