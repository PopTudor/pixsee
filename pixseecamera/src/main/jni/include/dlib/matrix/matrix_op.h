...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        const_ret_type operator()(long i) const { return matrix_exp<matrix_op>::operator()(i); }
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        const_ret_type operator()(long i) const { return matrix_exp<matrix_diag_op>::operator()(i); }
...
// ----------------------------------------------------------------------------------------
    ...
    struct does_not_alias {
        ...
        template<typename U>
        bool aliases(const U &) const { return false; }

        template<typename U>
        bool destructively_aliases(const U &) const { return false; }
    };
...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        template<typename U>
        bool aliases(const matrix_exp<U> &item) const {
