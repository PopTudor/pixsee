...
struct jpeg_destination_mgr {
    ...
    JMETHOD(int, empty_output_buffer, (j_compress_ptr
            cinfo));
...
struct jpeg_source_mgr {
    ...
    JMETHOD(int, fill_input_buffer, (j_decompress_ptr
            cinfo));
    ...
    JMETHOD(int, resync_to_restart, (j_decompress_ptr
            cinfo, int
            desired));
 ...
 */
typedef JMETHOD(int, jpeg_marker_parser_method, (j_decompress_ptr
        cinfo));
...
EXTERN(int) jpeg_start_decompress JPP((j_decompress_ptr
                                              cinfo));
EXTERN(JDIMENSION) jpeg_read_scanlines JPP((j_decompress_ptr
                                                   ...
                                                   scanlines,
                                                           JDIMENSION
                                                   max_lines));
EXTERN(int) jpeg_finish_decompress JPP((j_decompress_ptr
                                               cinfo));
...
EXTERN(int) jpeg_has_multiple_scans JPP((j_decompress_ptr
                                                cinfo));
EXTERN(int) jpeg_start_output JPP((j_decompress_ptr
                                          cinfo,
                                                  int
                                          scan_number));
EXTERN(int) jpeg_finish_output JPP((j_decompress_ptr
                                           cinfo));
EXTERN(int) jpeg_input_complete JPP((j_decompress_ptr
                                            cinfo));
...
EXTERN(int) jpeg_resync_to_restart JPP((j_decompress_ptr
                                               cinfo,
                                                       int
                                               desired));
