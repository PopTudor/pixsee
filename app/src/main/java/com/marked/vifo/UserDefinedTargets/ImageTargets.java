...
import com.marked.vifo.SampleAppMenu.SampleAppMenuInterface;
import com.marked.vifo.VuforiaApplication.ApplicationControl;
import com.marked.vifo.VuforiaApplication.ApplicationException;
import com.marked.vifo.VuforiaApplication.ApplicationSession;
import com.marked.vifo.VuforiaApplication.utils.GLDrawingSurfaceView;
import com.marked.vifo.VuforiaApplication.utils.LoadingDialogHandler;
...
public class ImageTargets extends AppCompatActivity implements ApplicationControl, SampleAppMenuInterface {
    ...
    // Our OpenGL view:
    private GLDrawingSurfaceView mGlView;
    // Our renderer:
...
//        mTextures = null;
    ...
    private void showErrorDialog() {
        ...
        mDialog = new AlertDialog.Builder(ImageTargets.this).create();
    ...
    private void initApplicationAR() { // TODO: 01-Oct-15 understand this
        ...
        mGlView = new GLDrawingSurfaceView(this);
    ...
    private void addOverlayView(boolean initLayout) {
        ...
        mUILayout = (RelativeLayout) inflater.inflate(R.layout.activity_preview, null, false);
...
//			return true;
    ...
    public boolean doInitTrackers() {
        ...
        TrackerManager trackerManager = TrackerManager.getInstance();
        Tracker tracker = trackerManager.initTracker(ObjectTracker.getClassType()); // init the tracker
        if (tracker == null) {
    ...
    public boolean doLoadTrackersData() {
        ...
        TrackerManager trackerManager = TrackerManager.getInstance();
        ObjectTracker objectTracker = (ObjectTracker) trackerManager.getTracker(ObjectTracker.getClassType());// give a
    ...
    public void showInitializationErrorMessage(String message) {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                builder.setMessage(errorMessage).setTitle(getString(R.string.INIT_ERROR)).setCancelable(false).setIcon(0)
