...
import com.marked.vifo.VuforiaApplication.utils.SampleApplication3DModel;
import com.marked.vifo.VuforiaApplication.utils.Teapot;
...
public class PreviewActivity extends AppCompatActivity implements ApplicationControl, SampleAppMenuInterface {
	...
	private void showErrorDialog() {
		...
		mDialog = new AlertDialog.Builder(PreviewActivity.this).create();
	...
	private void initApplicationAR() {
		...
		try {
			model.loadModel(getAssets(), "cube.obj");
		} catch (IOException e) {
			e.printStackTrace();
		}

		mRenderer = new UserDefinedTargetRenderer(this, vuforiaAppSession,new Teapot());
