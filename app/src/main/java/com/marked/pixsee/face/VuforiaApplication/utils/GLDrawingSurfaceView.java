...
package com.marked.pixsee.face.VuforiaApplication.utils;
...
public class GLDrawingSurfaceView extends GLSurfaceView {
    private static final String LOGTAG = "Vifo_GLView";


    // Constructor.
    public GLDrawingSurfaceView(Context context) {
        super(context);
    }
...
//		Log.i(LOGTAG, "Using " + (translucent ? "translucent" : "opaque") + " GLView, depth buffer size: " + depth +
