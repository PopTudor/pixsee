...
class SignUpNameFragment : Fragment() {
	private var mListener: SignUpNameFragment.SignUpNameFragmentInteraction? = null
	...
	override fun onAttach(context: Context?) {
		...
		if (context is SignUpNameFragment.SignUpNameFragmentInteraction)
			mListener = context as SignUpNameFragment.SignUpNameFragmentInteraction?
		else
