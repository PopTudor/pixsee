...
import com.marked.pixsee.delegate.DialogRegistration
import com.marked.pixsee.extra.GCMConstants
import com.marked.pixsee.extra.ServerConstants
import com.marked.pixsee.gcm.RegistrationBroadcastReceiver
import com.marked.pixsee.gcm.service.LogInRegistrationIntentService
import com.marked.pixsee.helper.add
import com.marked.pixsee.helper.addToBackStack
import com.marked.pixsee.ui.fragment.signup.SignUpEmailFragment
import com.marked.pixsee.ui.fragment.signup.SignUpNameFragment
import com.marked.pixsee.ui.fragment.signup.SignUpPassFragment
...
class SignUpActivity : AppCompatActivity(), SignUpNameFragment.SignUpNameFragmentInteraction, SignUpEmailFragment.SignUpEmailFragmentInteraction, SignUpPassFragment.SignUpPassFragmentInteraction {
    ...
    private fun checkEmail(email: String?) {
        val retrofit = Retrofit.Builder()
                ...
                .build()
        val service = retrofit.create(com.marked.pixsee.networking.LoginAPI::class.java)
