package com.marked.pixsee.ui.adapter;
...
import com.marked.pixsee.ui.adapter.viewholders.ImageHolder
import com.marked.pixsee.ui.adapter.viewholders.MessageHolder
import com.marked.pixsee.ui.adapter.viewholders.TypingHolder
	...
	fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
		...
		when (viewType) {
			...
			MessageConstants.MessageType.TYPING -> {
				...
				v = LayoutInflater.from(parent.context).inflate(com.marked.pixsee.R.layout.message_other_text, parent, false);
				return MessageHolder(v, context);
			}
		}
	}
