 ...
 */
class ChatDetailActivity : AppCompatActivity(), ChatDetailFragment.ContactDetailFragmentInteraction {
	companion object {
		const val EXTRA_CONTACT = "com.marked.vifo.ui.activity.EXTRA_CONTACT";
	}

	final val mFragment by lazy {
		ChatDetailFragment.newInstance(intent.getParcelableExtra(ChatDetailActivity.Companion.EXTRA_CONTACT))
	}
