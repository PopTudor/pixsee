...
public class ApplicationSession implements UpdateCallbackInterface {
    ...
    public void initAR(Activity activity, int screenOrientation) {
        ...
        if (mInitVuforiaTask != null) {
            ...
            vuforiaException = new ApplicationException(ApplicationException.VUFORIA_ALREADY_INITIALIZATED,
                    logMessage);
            Log.e(LOGTAG, logMessage);
        }

        if (vuforiaException == null) { // first time initialized
            try {
                mInitVuforiaTask = new InitVuforiaTask();
                mInitVuforiaTask.execute();
            } catch (Exception e) {
                String logMessage = "Initializing Vuforia SDK failed";
                vuforiaException = new ApplicationException(ApplicationException.INITIALIZATION_FAILURE,
                        logMessage);
                Log.e(LOGTAG, logMessage);
            }
        }

        if (vuforiaException != null) // show the error if there is one
    ...
    public void startAR(int camera) throws ApplicationException {
        ...
        if (mCameraRunning) {
            ...
            Log.e(LOGTAG, error);
            throw new ApplicationException(ApplicationException.CAMERA_INITIALIZATION_FAILURE,
                    error);
        }
    ...
    public void stopAR() throws ApplicationException {
        ...
        synchronized (mShutdownLock) {
            ...
            if (!unloadTrackersResult)
                throw new ApplicationException(ApplicationException.UNLOADING_TRACKERS_FAILURE,
                        "Failed to unload trackers\' data");

            if (!deinitTrackersResult)
                throw new ApplicationException(ApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
...
//					  mScreenWidth + " , " + mScreenHeight + "), mSize (" + xSize + " , " + ySize + ")");
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            synchronized (mShutdownLock) {
                Vuforia.setInitParameters(mActivity,mVuforiaFlags,mActivity.getString(R.string.vuforia_API_KEY));
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result) {
                Log.d(LOGTAG,
                        "InitVuforiaTask.onPostExecute: Vuforia " + "initialization successful");
                ...
                if (initTrackersResult) {
                    try {
                        ...
                        vuforiaException = new ApplicationException(ApplicationException.LOADING_TRACKERS_FAILURE,
                                logMessage);
                        Log.e(LOGTAG, logMessage);
                        mSessionControl.onInitARDone(vuforiaException);
                    }
                    ...
                    vuforiaException = new ApplicationException(ApplicationException.TRACKERS_INITIALIZATION_FAILURE,
