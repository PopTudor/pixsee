...
// ----------------------------------------------------------------------------------------
    ...
    USE_DEFAULT_INT_SERIALIZATION_FOR(unsigned
                                              short)
    ...
    USE_DEFAULT_BYTE_SERIALIZATION_FOR(signed
                                               char)

    USE_DEFAULT_BYTE_SERIALIZATION_FOR(unsigned
                                               char)
...
// ----------------------------------------------------------------------------------------
    ...
    inline void serialize_floating_point(
        ...
        catch (serialization_error &e) { throw serialization_error(e.info + "\n   while serializing a floating point number."); }
    }
...
// ----------------------------------------------------------------------------------------
    ...
    inline proxy_serialize serialize(const std::string &filename) { return proxy_serialize(filename); }

    inline proxy_deserialize deserialize(const std::string &filename) { return proxy_deserialize(filename); }
