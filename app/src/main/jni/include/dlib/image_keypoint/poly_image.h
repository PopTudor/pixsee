    ...
    private:
        ...
        matrix<float, 7, 1> rotate_order_6(
            ...
            M = w1, w2, w3, w4, w5, w6, w7,
                    ...
                    w3, (3 * w4 - 5 * w2), (15 * w1 - 8 * w3 + 6 * w5), (10 * w2 - 9 * w4 + 10 * w6), (6 * w3 - 8 * w5 + 15 * w7), (3 * w4 -
                                                                                                                                    5 *
                                                                                                                                    w6), w5,
                    w4, (4 * w5 - 4 * w3), (10 * w2 - 9 * w4 + 10 * w6), (-20 * w1 + 12 * w3 - 12 * w5 + 20 * w7), (-10 * w2 + 9 * w4 -
                                                                                                                    10 * w6), (4 * w5 -
                                                                                                                               4 * w3), -w4,
                    w5, (5 * w6 - 3 * w4), (6 * w3 - 8 * w5 + 15 * w7), (-10 * w2 + 9 * w4 - 10 * w6), (15 * w1 - 8 * w3 + 6 * w5), (
                    5 * w2 - 3 * w4), w3,
