...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(new impl_brns::impl_bridge<T, R>(network_parameters.port, &transmit_pipe.p, &receive_pipe.p));
        }
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(new impl_brns::impl_bridge<T, T>(network_parameters.port, &transmit_pipe.p, 0));
        }
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(new impl_brns::impl_bridge<R, R>(network_parameters.port, 0, &receive_pipe.p));
        }
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(
                    new impl_brns::impl_bridge<T, R>(network_parameters.ip, network_parameters.port, &transmit_pipe.p, &receive_pipe.p));
        }
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(new impl_brns::impl_bridge<R, R>(network_parameters.ip, network_parameters.port, 0, &receive_pipe.p));
        }
        ...
        void reconfigure(
            ...
            pimpl.reset();
            pimpl.reset(new impl_brns::impl_bridge<T, T>(network_parameters.ip, network_parameters.port, &transmit_pipe.p, 0));
        }
