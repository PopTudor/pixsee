...
namespace dlib {
    ...
    public:
        ...
        // POST
        const std::string &post_url(const std::string &url, const string_to_stringmap &postvars,
    ...
    private:
        ...
        bool parse_url(const std::string &url, std::string &scheme, std::string &user, std::string &pass, std::string &host, short &port,
