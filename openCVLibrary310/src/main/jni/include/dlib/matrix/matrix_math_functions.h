...
// ----------------------------------------------------------------------------------------
    ...
    struct op_complex_matrix2 : basic_op_mm<M1, M2> {
        ...
        const_ret_type apply(long r, long c) const { return type(this->m1(r, c), this->m2(r, c)); }
    };
...
// ----------------------------------------------------------------------------------------
    ...
    struct op_norm : basic_op_m<M> {
        ...
        const_ret_type apply(long r, long c) const { return std::norm(this->m(r, c)); }
    };
...
// ----------------------------------------------------------------------------------------
    ...
    struct op_real : basic_op_m<M> {
        ...
        const_ret_type apply(long r, long c) const { return std::real(this->m(r, c)); }
    };
...
// ----------------------------------------------------------------------------------------
    ...
    struct op_imag : basic_op_m<M> {
        ...
        const_ret_type apply(long r, long c) const { return std::imag(this->m(r, c)); }
    };
