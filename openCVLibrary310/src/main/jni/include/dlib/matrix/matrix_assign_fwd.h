...
// ----------------------------------------------------------------------------------------
    ...
    namespace ma {
        ...
        struct is_small_matrix<EXP, typename enable_if_c<EXP::NR >= 1 && EXP::NC >= 1 &&
                                                         EXP::NR <= 17 && EXP::NC <= 17 && (EXP::cost <= 70)>::type> {
        ...
        struct is_very_small_matrix<EXP, typename enable_if_c<EXP::NR >= 1 && EXP::NC >= 1 &&
                                                              (mul<EXP::NR, EXP::NC>::value <= 16) && (EXP::cost <= 70)>::type> {
            static const bool value = true;
        };
...
// ----------------------------------------------------------------------------------------
    ...
    inline typename enable_if_c<
            ma::is_small_matrix<src_exp>::value && ma::is_very_small_matrix<src_exp>::value == false>::type matrix_assign(
            matrix_dest_type &dest,
            const matrix_exp<src_exp> &src
    )
    /*!
...
// ----------------------------------------------------------------------------------------
    ...
    >
    inline typename enable_if_c<
            ma::is_small_matrix<src_exp>::value && ma::is_very_small_matrix<src_exp>::value == true>::type matrix_assign(
            matrix_dest_type &dest,
            const matrix_exp<src_exp> &src
    )
    /*!
